...
# Project root: inferred from this file's location (parent of prompt_learning/)
...
class Config:
    ...
    # Prompt text encoder
    # Prompt text encoder: set SCALECITY_BERT_PATH to a local folder for offline use;
    # otherwise the public model is downloaded from the HuggingFace Hub automatically.
    BERT_PATH = os.environ.get("SCALECITY_BERT_PATH", "BAAI/bge-base-zh-v1.5")
