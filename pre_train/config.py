...
# Project root: inferred from this file's location (parent of pre_train/)
...
class Config:
    ...
    DATA_DIR = "/path/to/urban_data"  # external data dir (e.g. SVI images); update for your environment
    H3_resolution = 8
    CITYNAME = "shenzhen"
    ...
    # ================= Model structure =================
    # Public encoders, auto-downloaded from the HuggingFace Hub by default.
    # Set the env vars below to local folders for offline use.
    CLIP_MODEL_NAME = os.environ.get("SCALECITY_CLIP_PATH", "openai/clip-vit-base-patch32")
    # For non-Chinese cities, switch to e.g. "sentence-transformers/all-mpnet-base-v2"
    text_MODEL_NAME = os.environ.get("SCALECITY_TEXT_ENCODER", "hfl/chinese-macbert-base")
